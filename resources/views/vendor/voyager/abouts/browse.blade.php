                ...
                <form action="{{route('page.update',$item->id)}}" method="POST" enctype='multipart/form-data'>
                    @csrf 
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <img src="{{asset('storage/pages/October2021/' . $item->image)}}" style="width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:10px;">
